  ...
  return (
   <>
    ...
    <VStack w={"full"}>
        ...
        <Text>This is a sample videos, This is a  teaser of the movie
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatem a voluptates accusamus sequi voluptas, eaque earum et sed esse nulla culpa sapiente veritatis, tempora animi provident maiores delectus aliquid ea laborum distinctio maxime ratione deserunt! Quas nesciunt unde atque ullam ratione libero sit rem voluptatem. Qui neque minima labore eveniet cumque ullam tenetur voluptatem excepturi reiciendis distinctio provident, similique debitis veniam non temporibus veritatis quos perspiciatis repellendus placeat velit nesciunt inventore rerum voluptatum necessitatibus! Vero repellat vel excepturi suscipit molestiae? Facere neque aperiam earum, blanditiis nostrum asperiores voluptatum deleniti vero, dolor provident officiis numquam explicabo, vel tenetur rerum odit. Ex?
       </Text>
    </VStack>
    </VStack>
    ...
    <VStack w={["full", "xl"]} alignItems={"stretch"} p={"8"} spacing={"8"} overflowY={"auto"}>
           ...
           return <Button colorScheme={"telegram"} variant={"ghost"} onClick={() => {
            return setVideoSrc(item)
           }}>
                Lecture {index + 1}
            </Button>
           })}
